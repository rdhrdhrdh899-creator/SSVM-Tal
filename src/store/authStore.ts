    ...
    (set) => ({
      ...
      loginWithGoogle: async () => {
        try {
          ...
          const isDevEmail = firebaseUser.email === 'rdhrdhrdh89.9@gmail.com' || firebaseUser.email === 'rahuljitalphanta@gmail.com';
          ...
          if (!userDoc.exists()) {
            ...
            if (isDevEmail && userData.role !== 'admin') {
              userData.role = 'admin';
