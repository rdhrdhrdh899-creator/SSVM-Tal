...
interface SettingsState {
  ...
  dismissEmergency: (message: string) => void;
...
export const useSettingsStore = create<SettingsState>((set) => ({
  ...
  loading: true,
  error: null,
  dismissedMessage: typeof window !== 'undefined' ? localStorage.getItem('dismissed-emergency-message') : null,
  dismissEmergency: (message) => {
    localStorage.setItem('dismissed-emergency-message', message);
